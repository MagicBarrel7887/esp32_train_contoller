...
public:
    ...
    double catmullSlope(double x[], double y[], int n, int i);
    double ConstrainedSpline(double xValues[], double yValues[], int numValues, double pointX, bool trim = true);
   double getFirstDerivate(double x[], double y[], int n, int i);
   double getLeftSecondDerivate(double x[], double y[], int n, int i);
   double getRightSecondDerivate(double x[], double y[], int numValues, int i);
};
